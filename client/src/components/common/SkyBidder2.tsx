...
export default function SkyBidder2() {
    return (
      ...
      <img
        ...
        alt="Triangle"
        className="absolute top-[10%] md:top-[45%] left-0 w-[30%] md:w-[50%] h-auto z-30"
      />
      <div className="p-10 z-40 relative">
        <h1>
          <span className="text-white text-[40px] font-[900]">twitter</span>
          <span className="text-[#FFC107] text-[40px] font-[900]">
            Tag
          </span>
        </h1>
        <p className="text-white font-[600] text-[24px] w-11/12 ">
        A Platform to add <br /> lables on your twitter posts!
        </p>
      </div>
    </div>
    )
